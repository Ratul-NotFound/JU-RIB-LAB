      ...
      <div className="container" style={{ padding: "var(--space-10) var(--space-6)" }}>
        <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: "var(--space-8)" }}>
          <div>
            ...
            <h1 className="text-h1" style={{ marginTop: "var(--space-2)" }}>My Articles & Lab Notes</h1>
            <p style={{ color: "var(--color-text-muted)" }}>Share protocols, research summaries, and conference reflections</p>
          </div>
        ...
        <div className="table-container">
          {loading ? (
            ...
            <div style={{ textAlign: "center", padding: "var(--space-12)", color: "var(--color-text-muted)" }}>
              ...
              <p>No articles written yet. Click "Write Article" to share your research thoughts.</p>
            </div>
          ) : (
          ...
          <div className="modal-overlay" onClick={() => setShowModal(false)}>
            <div className="modal" onClick={(e) => e.stopPropagation()} style={{ maxWidth: 700 }}>
              <div className="modal-header">
                <h2 className="modal-title">{editPost ? "Edit Article" : "Write Lab Article"}</h2>
                ...
                <div className="modal-body" style={{ display: "flex", flexDirection: "column", gap: "var(--space-4)" }}>
                  <div className="form-group">
                    ...
                    <input
                      ...
                      placeholder="e.g. My Experience with Western Blot Troubleshooting"
                      value={form.title}
                  ...
                  <div className="form-group">
                    <label className="form-label">Content (Markdown / Text) *</label>
                    <textarea
                      required
                      rows={8}
                      className="form-textarea"
                  ...
                  <div className="form-group">
                    ...
                    <input
                      className="form-input"
                      placeholder="Protocol, Lab, Student Research"
                      value={form.tags}
